...
def extract_WAUSHARA_permits(year):
    options = Options()
    ...
    try:
        driver.get("https://gis.co.waushara.wi.us/GCSWebPortal/Search.aspx")
        ...
        ))).select_by_visible_text("Zoning Department")
    ...
    # Add coordinates
    def get_parcel_info(parcel_id, county_name="WAUSHARA"):
